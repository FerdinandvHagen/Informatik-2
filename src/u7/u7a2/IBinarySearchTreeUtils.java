...
public interface IBinarySearchTreeUtils<T> {
	...
	/**
	 * Result of the unlinkSmallest operation
	 */
	class UnlinkSmallestResult<T> {
		/**
		 * the tree with the smallest key
		 */
		public BinarySearchTree<T> smallest;

		/**
		 * the remainder of the tree with the smallest tree removed
		 */
		public BinarySearchTree<T> tree;

		public UnlinkSmallestResult(BinarySearchTree<T> smallest,
	 ...
	 * 
	 * @param tree
	 *            the tree from where to remove the node. After this call this
	 *            tree should not be used any more. Use the returned
	 *            {@link UnlinkSmallestResult#tree} instead.
	 * @return both the tree with the smallest key and the remaining tree with
	 *         the smallest removed
	 */
